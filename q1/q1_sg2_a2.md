...
|**Checklist to guide your answer:**<br>**2. Readability**||
...
|✅Does the algorithm have fewer<br>conditions to check?|Does the algorithm have fewer<br>conditions to check?|
